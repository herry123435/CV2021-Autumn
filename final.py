...
def parseWoman(img, corners, contours, hulls):
    ...
    wCtr = (top[0] + (bRight[0] + bLeft[0])/2)/2
    # BODY
    parts[BODY].extend([corners[7], corners[8], corners[13], corners[12], corners[21], corners[23]])
    parts[BODY].append((corners[5] + corners[6])/2)
    # RIGHT_BRANCHIAL
    parts[RIGHT_BRANCHIAL].extend([corners[12], corners[7], corners[18]])
    parts[RIGHT_BRANCHIAL].append(right)
    # RIGHT_FOREARM
    parts[RIGHT_FOREARM].extend([corners[18], right, corners[23]])
    ...
    # LEFT_FOREARM
    parts[LEFT_FOREARM].extend([corners[19], left, corners[21], corners[22]])
    # RIGHT_THIGH
